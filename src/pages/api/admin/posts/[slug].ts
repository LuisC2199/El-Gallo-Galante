...
//   GET    – read a single post file
//   PUT    – update a single post file
//   DELETE – delete a single post file
// ---------------------------------------------------------------------------
...
export const PUT: APIRoute = async ({ params, request, locals }) => {
  ...
  try {
    body = await request.json() as SavePostRequest;
  } catch {
  ...
  if (!body.frontmatter?.date) errors.push("date is required");
  if (!body.frontmatter?.category) errors.push("category is required");
  ...
  try {
    ...
    const fileContent = serializePost(body.frontmatter, body.body);
    const commitMessage = `admin: update ${slug}`;
...
export const DELETE: APIRoute = async ({ params, request, locals }) => {
  ...
  try {
    ...
    await deleteFile(cfg, filePath, body.sha, `admin: delete post ${slug}`);
